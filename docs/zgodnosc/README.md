...
| **Licencja modeli rozpoznawania twarzy** | modele InsightFace (`find_faces`, CZ-14) mają licencję wyłącznie niekomercyjną. Warunek „dopóki produkt nie jest sprzedawany” przestał obowiązywać 21.09.2026 — sprzedaż jest włączona. **Rozstrzygnięcie właściciela z 21.09.2026:** sprzedaż działa na czas testów (testerzy robią zakupy testowe), funkcja zostaje w rejestrze, ryzyko przyjęte świadomie; zapis `NEXUS_LICENCJE_PRZYJETE=find_faces` gasi czerwone światło w diagnostyce, która nadal wypisuje, czego decyzja dotyczy. **Sprawa zostaje otwarta**: przed sprzedażą poza gronem testerów potrzebny jest model komercyjny, zgoda autorów albo wyłączenie funkcji |
