...
DZIEDZINY: list[tuple[str, str, str, tuple[str, ...]]] = [
    (
        ...
        ("design_vector", "design_compose"),
    ),
    (
        "zdjecia",
        "Zdjęcia i obrazy",
        "Poprawa, retusz, powiększanie, tło, montaż — bez programu graficznego.",
        ("enhance_photo", "retouch_portrait", "upscale_image", "remove_background",
         "change_background", "erase_objects", "convert_images", "imagemagick"),
    ),
    (
        "dokumenty",
        "Dokumenty i PDF",
        ...
        ("ocr_documents", "enhance_document_scan", "detect_document_boundaries", "pdf_merge",
         ...
         "write_document", "translate_document", "check_grammar"),
    ),
    (
        "wiedza",
    ...
    (
        "dzwiek",
        "Dźwięk i wideo",
        "Transkrypcja nagrań, napisy, cięcie i przygotowanie materiału.",
        ("transcribe_audio", "media_process"),
    ),
    (
        "strony",
        "Strony internetowe",
        ...
        ("site_list", "site_read_file", "site_write_file", "site_import_file", "site_delete_file",
         "site_save_version", "site_publish", "site_unpublish"),
    ),
    (
        "pliki",
        "Pliki i chmura",
