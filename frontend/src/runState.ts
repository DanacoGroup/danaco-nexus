...
export const TOOL_LABELS: Record<string, string> = {
  ...
  web_fetch_page: "Odczyt strony internetowej",
  scholar_search: "Wyszukiwanie publikacji naukowych",
  scholar_paper: "Szczegóły publikacji",
  knowledge_save: "Zapis w bazie wiedzy",
  knowledge_notes: "Notatki bazy wiedzy",
  knowledge_read: "Odczyt z bazy wiedzy",
  site_write_file: "Twórca stron: zapis pliku",
  site_read_file: "Twórca stron: odczyt pliku",
  site_list: "Twórca stron: pliki",
  site_delete_file: "Twórca stron: usunięcie pliku",
  site_import_file: "Twórca stron: import pliku",
  site_save_version: "Twórca stron: wersja",
  site_publish: "Publikacja strony",
  site_unpublish: "Wycofanie publikacji",
  remove_background: "Usuwanie tła",
  change_background: "Zmiana tła",
  erase_objects: "Usuwanie obiektów",
  translate_document: "Tłumaczenie dokumentu",
  mail_list: "Poczta: lista",
  mail_search: "Poczta: wyszukiwanie",
  mail_read: "Poczta: odczyt",
  mail_draft: "Poczta: szkic",
  mail_send: "Poczta: do wysłania",
  calendar_list: "Kalendarz",
  calendar_create: "Kalendarz: nowe wydarzenie",
  calendar_update: "Kalendarz: zmiana",
  calendar_delete: "Kalendarz: usunięcie",
  pc_info: "Komputer: informacje",
  pc_find_files: "Komputer: wyszukiwanie plików",
  pc_read_file: "Komputer: odczyt pliku",
  pc_powershell: "Komputer: PowerShell",
  pc_screenshot: "Komputer: zrzut ekranu",
  podagent: "Podagent",
