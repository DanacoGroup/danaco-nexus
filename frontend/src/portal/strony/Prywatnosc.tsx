// Polityka prywatności: treść z tresc-prawna.ts, jeden nagłówek pierwszego stopnia, spis rozdziałów.

import { Markdown } from "../../components/Markdown";
import { okruszki, usePozycjonowanie } from "../seo";
import { POLITYKA_PRYWATNOSCI as DOKUMENT } from "../tresc-prawna";
import { sciezka } from "../trasy";
import { NaglowekStrony, Odsylacz, Okruszki } from "../ui";

export function Prywatnosc() {
  usePozycjonowanie({
    tytul: DOKUMENT.tytul,
    opis: DOKUMENT.opis,
    sciezka: "/portal/prywatnosc",
    dane: okruszki([
      { nazwa: "Portal", sciezka: sciezka("glowna") },
      { nazwa: DOKUMENT.tytul, sciezka: "/portal/prywatnosc" },
    ]),
  });
